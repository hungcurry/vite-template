...
<template>
  <WelcomeItem>
    <template #icon>
      <SvgIcon name="IconCommunity" color="#f00" className="ion-primary" />
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <SvgIcon name="IconDocumentation" color="#da2" className="ion-primary" />
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <SvgIcon name="IconEcosystem" color="#00f" className="ion-primary" />
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <SvgIcon name="IconSupport" color="#aa0" className="ion-primary" />
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <SvgIcon name="IconTooling" color="#d85" className="ion-primary" />
    </template>
